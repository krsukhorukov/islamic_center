...
class Timetable(models.Model):
    ...
    time_sunrise = models.CharField(max_length=100)
    time_sunset = models.CharField(max_length=100)
    time_satar = models.CharField(max_length=100)
    time_fajr = models.CharField(max_length=100)
    time_zuhr = models.CharField(max_length=100)
    time_asr = models.CharField(max_length=100)

    def __str__(self):
        return f"Prayer Timetable - {self.date}"
